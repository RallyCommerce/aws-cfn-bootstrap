...
class ProcessHelper(object):
    ...
    def call(self):
        ...
        if os.name == WINDOWS:
            ...
            tmp_stdout_path = os.path.join(
                tmp_dir_path,
                "subp-stdout-{}.log".format(unique_id)
            )
            tmp_stderr_path = os.path.join(
                tmp_dir_path,
                "subp-stderr-{}.log".format(unique_id)
            )
            ...
            with open(tmp_stdout_path, "w") as tmp_stdout_writer, open(tmp_stderr_path, "w") as tmp_stderr_writer:
                process = subprocess.Popen(
                    command,
                    stdout=tmp_stdout_writer,
                    stderr=tmp_stderr_writer,
            ...
            with open(tmp_stdout_path, "r") as tmp_stdout_reader, open(tmp_stderr_path, "r") as tmp_stderr_reader:
                return_data = [
                    tmp_stdout_reader.read(),
                    tmp_stderr_reader.read()
                ]
